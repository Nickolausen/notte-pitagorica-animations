...
class Intro(Scene):
    def construct(self):
        pres_title = Tex(r"\textsc{Si può risolvere a caso un cubo di Rubik?}").scale_to_fit_width(self.camera.frame_width - 3)
        subtitle = Tex(r"\textbf{Luca Brasini} \textit{- atleta di speedcubing, \\ ex studente @ I.T.T. 'Blaise Pascal'}")
