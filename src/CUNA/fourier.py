...
class Fourier(Scene):
    def construct(self):
        ...
        self.play(DrawBorderThenFill(self.axes))
        # self.play(Create(graph_func))

        self.prepare_fourier_animation()
        math_series.align_to(self.axes, UP).shift(UP * 2)
    ...
    def prepare_fourier_animation(self):
        ...
        self.math_n_equals.align_to(self.axes, UR).shift(LEFT + UP * 2)
    ...
    def animate_fourier_series(self, start, end, step):
        ...
        for n in range(start, end + 1, step):
            ...
            if self.graph_series is not None:
                ...
                self.play(Create(graph_series_new), run_time=5)
                self.play(Write(n_series_new))
